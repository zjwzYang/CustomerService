 ...
 * @org 浙江趣看点科技有限公司
 */
public class OccuptionThreeThreeAdapter extends RecyclerView.Adapter<OccuptionThreeThreeAdapter.OccuptionViewHolder> {

    private Context context;
    private List<OccupationBean.ChildrenDTOX.ChildrenDTO> dateList;
    private LayoutInflater inflater;

    private OnClickThreeItem mOnClickThreeItem;
    private int currPosition = 0;

    public OccuptionThreeThreeAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull @NotNull OccuptionViewHolder holder, final int position) {
        final OccupationBean.ChildrenDTOX.ChildrenDTO dto = dateList.get(position);
    ...
    public void addAll(List<OccupationBean.ChildrenDTOX.ChildrenDTO> dateList) {
        currPosition = 0;
        this.dateList = dateList;
        notifyDataSetChanged();
    }

    public OccupationBean.ChildrenDTOX.ChildrenDTO getCurrBean() {
    ...
    public interface OnClickThreeItem {
        void onClickThree(OccupationBean.ChildrenDTOX.ChildrenDTO bean);
    }
} 