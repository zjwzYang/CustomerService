 ...
 * @org 浙江趣看点科技有限公司
 */
public class OccuptionThreeOneAdapter extends RecyclerView.Adapter<OccuptionThreeOneAdapter.OccuptionViewHolder> {
    ...
    public OccuptionThreeOneAdapter(Context context, List<OccupationBean> detail) {
    ...
    public void onBindViewHolder(@NonNull @NotNull OccuptionViewHolder holder, final int position) {
        final OccupationBean dto = detail.get(position);
    ...
    public OccupationBean getCurrBean() {
    ...
    public interface OnClickOneItem {
        void onClickOne(OccupationBean bean);
    }
} 